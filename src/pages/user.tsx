...
export default function UserPage() {
  ...
  return (
    <div className="bg-linear-to-r from-primary to-secondary w-screen h-screen flex gap-4 p-17">
      <div className="justify-between max-w-7xl mx-auto bg-gray-300/40 backdrop-blur-2xl border-gray-100 rounded-2xl flex flex-col gap-9 p-7 items-center w-full">
